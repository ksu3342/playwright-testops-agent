...
def _render_executable_login_script(
    ...
    lines = [
        ...
        "# By default it owns its demo server thread and port to avoid reusing an unstable external localhost:3000 server.",
        "",
        "",
        ...
        "    thread.start()",
        "    try:",
        "        _wait_for_login_page(owned_base_url, thread=thread)",
